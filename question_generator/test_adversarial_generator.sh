...
CUDA_VISIBLE_DEVICES=0 python adversarial_question_generator.py --do_test --model_type roberta --model_name_or_path /home/pritam/MRC/pretrained_model/roberta/ --load_model_path out_dir_adv/checkpoint-best-bleu/pytorch_model.bin --dev_filename  /home/pritam/MRC/output/reddit_ner.csv  --output_dir $output_dir --max_source_length $source_length --max_target_length $target_length --beam_size $beam_size --eval_batch_size $batch_size --data_type reddit